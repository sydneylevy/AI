...
public class pstMain extends PApplet {
	...
	Tree<Character> tree3 = new Tree();
	Tree<Character> tree4 = new Tree();
...
//		// which line to read in --> this object only reads one line (or ie, voice or ie, one instrument)'s worth of data from the file
	...
	public void gui() {
		...
		fill(0);
		textSize(20);
		text("Press 1 for ABRACADABRA", 120, 110);
		text("Press 2 for ACADAACBDA", 120, 310);
		text("Press 3 for ABCCCDAADCDAABCADAD", 120, 510);
		text("Press 4 for Mary Had A Little Lamb", 120, 710);
